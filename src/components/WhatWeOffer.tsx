  ...
  return (
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Worldwide Shipping
                </h3>
                <p className="text-base font-medium text-body-color">we ship Worldwide whenever you are on earth!</p>
            </div>
        </div>
    </div>
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Diffrent Payment Methods
                </h3>
                <p className="text-base font-medium text-body-color"> We accept applePay, STCpay, credit card, and payment upon receipt</p>
            </div>
        </div>
    </div>
