        ...
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
          ...
          <div>
            ...
            <p className="text-base font-medium text-body-color">
              we ship Worldwide whenever you are on earth!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
          ...
          <div>
            ...
            <p className="text-base font-medium text-body-color">
              {' '}
              We accept applePay, STCpay, credit card, and payment upon receipt
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
          ...
          <div>
            ...
            <p className="text-base font-medium text-body-color">
              Simple and easy-to use form API all you need to paste your end-point URL on your form,
              rest assured by FormBold.
            </p>
          </div>
        </div>
      </div>
